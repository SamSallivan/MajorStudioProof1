...
Shader "Distant Lands/Cozy/Stylized Terrain First Pass"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 id5_g81 = 0;
			float2 uv5_g81 = 0;
			float voroi5_g81 = voronoi5_g81( coords5_g81, time5_g81, id5_g81, uv5_g81, 0, voronoiSmoothId0 );
			...
			float2 id1_g83 = 0;
			float2 uv1_g83 = 0;
			float voroi1_g83 = voronoi1_g83( coords1_g83, time1_g83, id1_g83, uv1_g83, 0, voronoiSmoothId0 );
			float time8_g83 = 2.16;
			float2 coords8_g83 = i.uv_texcoord * ( temp_output_5_0_g83 * 3.0 );
			float2 id8_g83 = 0;
			float2 uv8_g83 = 0;
			float voroi8_g83 = voronoi8_g83( coords8_g83, time8_g83, id8_g83, uv8_g83, 0, voronoiSmoothId0 );
			float4 appendResult205_g36 = (float4(_Smoothness0 , _Smoothness1 , _Smoothness2 , _Smoothness3));
			float4 appendResult206_g36 = (float4(tex2DNode4_g36.a , tex2DNode3_g36.a , tex2DNode6_g36.a , tex2DNode7_g36.a));
			float4 defaultSmoothness210_g36 = ( appendResult205_g36 * appendResult206_g36 );
			float dotResult216_g36 = dot( defaultSmoothness210_g36 , SplatControl26_g36 );
			o.Smoothness = ( ( ase_worldNormal.y * 2.0 * ( (1.0 + (voroi1_g83 - 0.0) * (0.0 - 1.0) / (0.4 - 0.0)) + (0.1 + (voroi8_g83 - 0.0) * (-0.3 - 0.1) / (0.21 - 0.0)) ) * (0.3 + (CZY_WetnessAmount - 0.0) * (1.0 - 0.3) / (1.0 - 0.0)) ) > ( 1.0 - ( CZY_WetnessAmount * dotResult216_g36 ) ) ? 1.0 : 0.0 );
...
/*ASEBEGIN
Version=18912
0;1080;2194;606;904.4087;46.02774;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;65;-86.21644,-201.3231;Inherit;False;Property;_RockColor;Rock Color;31;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.4433958,0.4433958,0.4433958,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;138;-78.64612,279.8251;Inherit;False;StylizedRainPuddles;-1;;83;ff913d501aadc8b4cb4ec6889f2354ca;0;1;14;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;657.0565,40.11808;Float;False;True;-1;2;;0;0;Standard;Distant Lands/Cozy/Stylized Terrain First Pass;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;-100;True;Opaque;;Geometry;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;Nature/Terrain/Diffuse;32;-1;-1;-1;0;False;2;BaseMapShader=Distant Lands/Stylized Terrain;AddPassShader=Distant Lands/Stylized Terrain Add Pass;0;False;-1;-1;0;False;-1;0;1;finalcolor:SplatmapFinalColor;0;True;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
